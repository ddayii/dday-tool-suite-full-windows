...
2. Run `DDay Controls Tool Suite Setup 2.2.1.exe`
...
The Scalar Converter, Unit Converter, ASCII Chart, and Calculators are also available as a Progressive Web App:
